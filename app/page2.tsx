            ...
            {activeTab === 'preview' && (
              <div className="space-y-8">
                ...
                <div className="bg-white border rounded-xl p-10 space-y-8">
                  ...
                  {/* Header */}
                  <div className="text-center border-b-2 border-red-600 pb-8">
                    <div className="flex items-center justify-center space-x-4 mb-6">
                      ...
                      <div>
                        <div className="text-2xl font-bold" style={{color: '#DC2626'}}>ТОВ«ВедеВперед»</div>
                      </div>
                    </div>
                    
                    <h1 className="text-3xl font-bold text-gray-900 mb-4 uppercase">КОМЕРЦІЙНА ПРОПОЗИЦІЯ</h1>
                    <h2 className="text-xl font-bold mb-4 uppercase" style={{color: '#DC2626'}}>{formData.productDescription}</h2>
                    <h3 className="text-2xl font-bold mb-6" style={{color: '#DC2626'}}>{formData.productName} (без розчинників)</h3>
                    <div className="bg-red-50 rounded-lg p-4 inline-block">
                      <p className="text-gray-800 font-semibold">
                        на бетонній підлозі в приміщенні площею <span className="text-xl font-bold" style={{color: '#DC2626'}}>{formData.areas.reduce((sum, area) => sum + area.size, 0)} кв.м.</span>
                      </p>
                    ...
                    <div key={area.id} className="border-t-2 border-gray-200 pt-8">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 mb-4">
                        ...
                        <p className="text-sm text-gray-600">
                          Дилерська знижка {area.discount}%. Разом = <span className="font-bold" style={{color: '#DC2626'}}>{calculateAreaCost(area).toLocaleString('uk-UA', { minimumFractionDigits: 2 })} грн</span>
                        </p>
                              ...
                              .map((material, materialIndex) => {
                                ...
                                return (
                                  <tr key={material.id}>
                                    ...
                                    <td className="p-3 border border-gray-300 font-semibold" style={{color: '#DC2626'}}>{cost.toLocaleString('uk-UA', { minimumFractionDigits: 2 })}</td>
                                  </tr>
                                );
                              })}
                          </tbody>
                  ...
                  {/* Total */}
                  <div className="border-t-4 border-red-600 pt-8 text-center">
                    <h2 style={{
                      fontSize: '2rem',
                      fontWeight: 'bold',
                      color: '#DC2626',
                  ...
                  <div className="text-center border-t-2 border-gray-200 pt-6">
                    <div className="space-y-2 text-gray-700">
                      ...
                      <p className="font-semibold" style={{color: '#DC2626'}}>Власник ТМ PoliBest</p>
                      <p className="font-semibold" style={{color: '#DC2626'}}>Виробник продукції ТМ PoliBest</p>
                    ...
                    <div className="flex items-center justify-center space-x-4 mt-6">
                      ...
                      <div className="text-2xl font-bold" style={{color: '#DC2626'}}>ТМ PoliBest</div>
                    </div>
                  </div>
                </div>
              </div>
