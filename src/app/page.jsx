...
const ProposalBuilder = () => {
  ...
  const calculateAreaCost = (area: Area) => {
    let totalCost = 0;
  ...
  const updateArea = (id, field: keyof Area, value) => {
    setFormData({
      ...formData,
  ...
  const toggleMaterialForArea = (areaId, materialId) => {
    setFormData({
      ...formData,
      areas: formData.areas.map(area => {
        if (area.id === areaId) {
  ...
  const updateMaterial = (id, field: keyof Material, value) => {
    setFormData({
      ...formData,
